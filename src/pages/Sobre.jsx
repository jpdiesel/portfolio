  ...
  render() {
    ...
    return (
      <div>
        ...
        <h2 className='title-text'>Meus Projetos</h2>
        <nav id="projects">
          <ul>
            <li>
