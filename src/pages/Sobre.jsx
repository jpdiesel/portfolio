        ...
        <nav>
          <ul className={theme} id="projects">
            ...
            <li>
              ...
              {openPopup2 ? <Popup closePopup={() => this.closePopup(2)} svg={svgColor} theme={theme} projectId={2} project={ projetos[3] } openPopup={ this.openPopup }/> : null}
            </li>
             <li>
              ...
              {openPopup3 ? <Popup closePopup={() => this.closePopup(3)} svg={svgColor} theme={theme} projectId={3} project={ projetos[5] } openPopup={ this.openPopup }/> : null}
            </li>
            <li>
              <div className={['project-links', theme].join(" ")} onClick={() => this.openPopup(4)}>
                <svg fill='currentColor' height="80px" id="sc" version="1.1" viewBox="0 0 48 48" width="80px" space="preserve" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"><path d="M37,47H11c-2.209,0-4-1.791-4-4V8c0-2.209,1.791-4,4-4h3l0,0c0.553,0,1,0.448,1,1  s-0.447,1-1,1l0,0h-3C9.896,6,9,6.896,9,8v35c0,1.104,0.896,2,2,2h26c1.104,0,2-0.896,2-2V8c0-1.104-0.896-2-2-2h-3l0,0  c-0.553,0-1-0.448-1-1s0.447-1,1-1c0,0,0,0,0.001,0H37c2.209,0,4,1.791,4,4v35C41,45.209,39.209,47,37,47z M35,9  c0,0.552-0.447,1-1,1H14c-0.553,0-1-0.448-1-1s0.447-1,1-1c0,0,1.125-0.125,2-1l2-2c0,0,0.781-1,2-1h1c0-1.657,1.344-3,3-3  c1.657,0,3,1.343,3,3h1c1.312,0,2,1,2,1l2,2c0.875,0.875,2,1,2,1C34.553,8,35,8.448,35,9z M24,3c-0.553,0-1,0.448-1,1h2  C25,3.448,24.553,3,24,3z M29.363,7c0,0-0.679-1-1.817-1h-7.091c-1.14,0-1.818,1-1.818,1l-0.909,1h12.545L29.363,7z"/></svg>
              </div>
              <p className={["project-name", theme].join(" ")}>Inventory Report</p>
              {openPopup4 ? <Popup closePopup={() => this.closePopup(4)} svg={svgColor} theme={theme} projectId={4} project={ projetos[2] } openPopup={ this.openPopup }/> : null}
            </li>
            <li>
              <div className={['project-links', theme,].join(" ")} onClick={() => this.openPopup(5)}>
                <svg id="sc" fill="currentColor" height="80" viewBox="0 0 48 48" width="80" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6 14C6 4 14 4 14 4V24H6C6 24 6 24 6 14Z"/><rect height="6" stroke-linejoin="round" stroke-width="4" width="28" x="14" y="10"/><path d="M6 30H42C42 30 42 38 36 38C30 38 29 38 29 38L31 44H13L15 38H6V30Z"/>
                </svg>
              </div>
              <p className={["project-name", theme].join(" ")}>Smith</p>
            ...
            <li>
              <div className={['project-links', theme].join(" ")} onClick={() => this.openPopup(6)}>
                <svg id="sc" height="80" viewBox="0 0 512 512" fill='currentColor' width="80" xmlns="http://www.w3.org/2000/svg"><title/>
              ...
              <p className={["project-name", theme].join(" ")}>Commerce</p>
              {openPopup6 ? <Popup closePopup={() => this.closePopup(6)} svg={svgColor} theme={theme} projectId={6} project={ projetos[1] } openPopup={ this.openPopup }/> : null}
            </li>
            </div>
            ...
            <li>
              <div className={['project-links', theme].join(" ")} onClick={() => this.openPopup(9)}>
                <svg id="sc" height="80" viewBox="0 0 1792 1792" width="80" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className={["project-name", theme].join(" ")}>All For One</p>
