      ...
      <div>
        <header className="header">
          <nav className="page-sections">
            ...
            <HashLink className='links' smooth to="#projects">Projetos</HashLink>
            ...
            <HashLink className='links' smooth to="#contact">Contato</HashLink>
          </nav>
        </header>
        ...
        <h2 className='title-text' id="my-projects">Meus Projetos</h2>
        <nav>
          <ul id="projects">
            <li>
