      ...
      <div>
        ...
        <nav>
          <ul className={theme} id="projects">
            <li>
              <Link className={['project-links', theme].join(" ")} onClick={() => this.openPopup(1)} >
            ...
            <li>
              <Link className={['project-links', theme,].join(" ")} onClick={() => this.openPopup(2)}>
                <svg id="sc" xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-cart-fill" viewBox="0 0 16 16">
            ...
            <li>
              <Link className={['project-links', theme].join(" ")} onClick={() => this.openPopup(3)}>
                <svg id="sc" xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-list-check" viewBox="0 0 16 16">
            ...
            <li>
              <Link className={['project-links', theme].join(" ")} onClick={() => this.openPopup(4)}>
                <svg id="sc" xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-headphones" viewBox="0 0 16 16">
            ...
            <li>
              <Link className={['project-links', theme].join(" ")} onClick={() => this.openPopup(5)}>
                <svg id="sc" xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-person-vcard" viewBox="0 0 16 16">
            ...
            {/* <p>Esse projeto foi criado usando REACT. Particularmente, esse foi o projeto mais difícil que eu fiz, não por causa
             ...
             <li>
              <Link className={['project-links', theme].join(" ")} onClick={() => this.openPopup(6)}>
                <svg id="sc" xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-wallet2" viewBox="0 0 16 16">
