      ...
      <div>
        <header className={["header", theme].join(" ")}>
          <nav className="page-sections">
            ...
            <HashLink className='links' smooth to="#my-projects">Projetos</HashLink>
            <HashLink className='links' smooth to="#skills-section">Skills</HashLink>
            <HashLink className='links' smooth to="#experience">Experiências</HashLink>
            <HashLink className='links' smooth to="#contact-bar">Contato</HashLink>
          </nav>
        </header>
        ...
        <h2 className={['title-text', theme].join(" ")} id="my-projects">Meus Projetos</h2>
        <nav>
        ...
        <h2 className={['title-text', theme].join(" ")}>Contato</h2>
